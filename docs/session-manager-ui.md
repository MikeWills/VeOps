...
`wwwroot/css/app.css` design-system stylesheet (dark chassis, IBM Plex Sans/Mono — Inter/JetBrains Mono since 2026-09-11, see
`docs/typography.md` — chip/meter/kebab/
