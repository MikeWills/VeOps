...
The page is organized by **moment**, not by message. Each heading is something that happens — a
...
![FCC Status with the master switch on, revealing three sub-switches for new license, upgrade and renewal candidates](images/fcc-status.png)
