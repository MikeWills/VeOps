...
public class WebAppFactory : WebApplicationFactory<Program>
{
    ...
    /// </summary>
    public List<VeOps.Core.Email.EmailMessage> SentEmails { get; } = [];

    private sealed class CapturingEmailSender(List<VeOps.Core.Email.EmailMessage> sent)
        : VeOps.Core.Email.IEmailSender
    {
        public Task SendAsync(
            VeOps.Core.Email.EmailCredentials credentials,
            VeOps.Core.Email.EmailMessage message,
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.RemoveAll<VeOps.Core.Email.IEmailSender>();
            services.AddSingleton<VeOps.Core.Email.IEmailSender>(new CapturingEmailSender(SentEmails));
