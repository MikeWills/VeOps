...
public class IngestionStampTests
{
    ...
    private sealed class UnreachableClients : IZoomClient, IDiscordEventClient, IDiscordChannelMessageClient, ISquareClient, IEmailSender
    {
        ...
        public Task<IReadOnlyList<DiscordChannelSummary>> ListTextChannelsAsync(ulong g, CancellationToken ct) => Nope<IReadOnlyList<DiscordChannelSummary>>();
