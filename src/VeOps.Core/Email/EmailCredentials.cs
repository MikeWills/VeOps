...
public sealed record EmailCredentials(int TeamId, string Host, int Port, string Username, string Password);
...
public static class TeamEmailCredentialsExtensions
{
    public static EmailCredentials ToEmailCredentials(this Team team) =>
        new(team.Id, team.SmtpHost!, team.SmtpPort ?? 587, team.SmtpUsername!, team.SmtpPassword ?? "");
