...
using VeOps.Core.Reconciliation;
using VeOps.Core.Retention;
...
// application name and key-ring path here MUST exactly match VeOps.Web's own
...
// Phase 10: also used by VeOps.Web's Admin/SystemSettings page to edit the same row.
